...
public class SensitiveFilter {
    ...
    private void addKeyword(String keyword) {
        ...
        for (int i = 0; i < keyword.length(); i++) {
            ...
            TrieNode subNode = tempNode.getNode(c);

            if (subNode == null) {
                // 初始化子节点
                subNode = new TrieNode();
                tempNode.setNode(c, subNode);
            }
    ...
    private class TrieNode{
        ...
        public void setKeyEnd(boolean keuEnd) {
            isKeyEnd = keuEnd;
        }
        ...
        public void setNode(Character character,TrieNode node) {
